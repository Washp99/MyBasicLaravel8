...
use App\Exports\EmployeeExportFormView;
...
class EmployeeController extends Controller
{
    ...
    public function exportexcelmap()
    {
        // return Excel::download(new EmployeeExport, 'datapegawai'.Carbon::now()->timestamp.'.xlsx');
        return (new EmployeeExportMap)->download('datapegawai'.Carbon::now()->timestamp.'.xlsx');
    }

    public function exportexcelfromview()
    {
        // return Excel::download(new EmployeeExport, 'datapegawai'.Carbon::now()->timestamp.'.xlsx');
        return (new EmployeeExportFormView)->download('datapegawai'.Carbon::now()->timestamp.'.xlsx');
    }
