  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row g-3 align-items-center mt-2 mb-2">
        ...
        <div class="col-auto">
          <a href="/exportexcel" class="btn btn-success">Export Excel All</a>
        </div>
        <div class="col-auto">
          <a href="/exportexcelgender/male" class="btn btn-success">Export Excel Male</a>
        </div>
        <div class="col-auto">
          <a href="/exportexcelgender/female" class="btn btn-success">Export Excel Female</a>
        </div>
        <div class="col-auto">
          <a href="/exportexcelmap" class="btn btn-success">Export Excel Map</a>
        </div>
        <div class="col-auto">
          <a href="/exportexcelfromview" class="btn btn-success">Export Excel From View</a>
        </div>
        <div class="col-auto">
