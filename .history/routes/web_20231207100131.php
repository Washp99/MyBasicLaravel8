...
Route::get('/exportexcelgender/{gender}',[EmployeeController::class,'exportexcelgender'])->name('exportexcelgender');
Route::get('/exportexcelmap',[EmployeeController::class,'exportexcelmap'])->name('exportexcelmap');
Route::get('/exportexcelfromview',[EmployeeController::class,'exportexcelfromview'])->name('exportexcelfromview');
Route::get('/importexcel',[EmployeeController::class,'importexcel'])->name('importexcel');